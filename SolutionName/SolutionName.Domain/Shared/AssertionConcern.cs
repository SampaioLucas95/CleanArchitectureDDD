...
namespace SolutionName.Domain.Shared
{
    public class AssertionConcern
    {
        ...
        public static void AssertArgumentNotNegative(decimal valor, string message)
        {
            if (valor < 0)
            {
                throw new DomainException(message);
        ...
        public static void AssertArgumentNotEqualZero(decimal valor,string message)
        {
            if (valor == 0)
            {
                throw new DomainException(message);
